// Generated on 2013-11-04 using generator-webapp 0.4.2
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        cssmin: {
            ...
            // dist: {
            //     files: {
            //         '<%= yeoman.app %>/css/*.css': ['<%= yeoman.dist %>/css/*.css']
            //     }
            // }

            dist: {
                files: {
                    '<%= yeoman.dist %>/css/screen.css': [
                        '.tmp/styles/{,*/}*.css',
                        '<%= yeoman.app %>/css/{,*/}*.css'
                    ]
                }
        ...
        //     outputFile: '<%= yeoman.dist %>/js/modernizr.js',
        //     files: [
        //         '<%= yeoman.dist %>/scripts/{,*/}*.js',
        //         '<%= yeoman.dist %>/css/{,*/}*.css',
